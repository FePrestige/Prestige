...
(function () {
  ...
  // Web3Forms: submit in the background and show an inline message (no page redirect)
  function initForm() {
      ...
      form.addEventListener("submit", function (e) {
        ...
        fetch("https://api.web3forms.com/submit", {
          ...
          if (data.success) {
            form.reset();
            if (status) {
              status.style.color = "var(--green-primary)";
          ...
          if (status) {
            ...
            status.textContent = en
              ? "Something went wrong. Please try again or write to us."
              : "Algo salió mal. Intente de nuevo o escríbanos.";
          }
        }).finally(function () {
